...
/-! Informal proof:
1. Obviously, for any Matrix $A \in G$, we have $A = (A_{1 1} I) (A / A_{1 1}) \in D \times U$
2. It is trivial on math, but many related concepts are lacking in lean at the moment
-/
